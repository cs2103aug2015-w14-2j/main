...
public class SystemTest {
	...
	public void testNew() {
		...
		Logic logic = controller.getLogic();
		...
		assertEquals(expected.getReturnMessage(), output6.getReturnMessage());
		...
		expected.setOutput(expectedArrayList);
		expected.setReturnMessage("All tasks are now displayed!");
		System.out.println(expected.getTasks());
		System.out.println(output8.getTasks());
